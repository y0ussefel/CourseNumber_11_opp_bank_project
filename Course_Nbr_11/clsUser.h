...
private:
     ...
     string _PrepareLogInRecord(string Separator= "#//#")
    {
        ...
        Record += clsUtil::EncryptText(Password, 2) + Separator;
        Record += to_string(Permissions)+Separator;
...
public:
    enum enPermissions {
        ...
        pUpdateClients = 8, pFindClient = 16, pTranactions = 32, pManageUsers = 64, pShowLoginRegester = 128
    };
    struct stLoginRegisterRecord
    {
        string DateTime;
    ...
    {
        fstream File;
        File.open("RegisterLog.txt", ios::out |ios::app);
     ...
     static  vector <stLoginRegisterRecord> GetLoginRegisterList()
     {
         ...
         fstream MyFile;
         MyFile.open("RegisterLog.txt", ios::in);//read Mode
